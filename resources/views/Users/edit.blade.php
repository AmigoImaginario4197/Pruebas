...
<head>
    ...
    {{-- SweetAlert2 se carga de forma global desde un CDN --}}
    <script src="//cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    
    {{-- Vite se encarga de compilar e incluir todos nuestros archivos CSS y JS --}}
    @vite(['resources/css/app.css', 'resources/js/app.js', 'resources/js/alerts.js', 'resources/js/user-form-mananger.js'])
</head>

{{-- Pasamos los datos de sesión (errores y éxito) al JS a través de atributos data-* en el body --}}
<body 
    ...
    <div class="panel-container">     
        ...
        <main class="panel-main">
            ...
            <div class="panel-content">
                <div class="card">
                    {{-- El formulario HTML no necesita cambios, está perfecto --}}
